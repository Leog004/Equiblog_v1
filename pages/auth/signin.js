...
export default function SignIn({ csrfToken, error }) {
  ...
  return (
    ...
    <h1 className='w-full text-center text-gray-700 font-semibold text-3xl leading-10 my-2 capitalize'>User Login</h1>
    <p className='w-full text-center text-md text-gray-500 mb-14'>Welcome Back!</p>

    <form className='w-1/3 my-10 mx-auto grid grid-cols-1 gap-5 justify-between' method="post" action="/api/auth/callback/credentials">
      ...
      <button className='bg-yellow-700 text-white px-4 py-3 rounded-lg' type="submit">Sign in</button>
    </form>
